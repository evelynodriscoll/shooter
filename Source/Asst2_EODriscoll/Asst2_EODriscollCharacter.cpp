...
void AAsst2_EODriscollCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AAsst2_EODriscollCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AAsst2_EODriscollCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AAsst2_EODriscollCharacter::GetHasRifle()
{
	return bHasRifle;
}